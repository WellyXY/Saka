...
const agentsData = [
  ...
  },
  {
    ...
    status: "working",
    tasks: [
      {date: "2026-03-12", description: "Adding Agent Task Dashboard to Saka", status: "in_progress", time: "Now"},
      ...
      {date: "2026-03-10", description: "Post Tracking page implementation", status: "completed", time: "2d ago"}
    ]
  },
  {
    type: "saga",
